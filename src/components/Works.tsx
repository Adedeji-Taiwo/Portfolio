...
const ProjectCard = ({index, name, description, tags, image, source_code_link}:{index:number, name:string, description:string, tags:{name:string, color:string}[], image:string, source_code_link:string}) => {
  return (
    <motion.div
...
const Works = () => <SectionWrapper Component={WorksSection} idName="work" />
